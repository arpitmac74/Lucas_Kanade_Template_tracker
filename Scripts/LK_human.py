...
images = []
imagesColor = []
for file in glob.glob(f"data/human/*.jpg"):
...
# human
rect = np.array([[250,285],[290,285],[290,365],[250,265]])
rectDraw = np.array([[260,290],[285,290],[285,358],[260,358]])
p = np.zeros(6) 
...
#    output = cv2.polylines(imagesColor[i],[rectTemp],True,(0,255,0),thickness = 3)
    output = cv2.polylines(imagesColor[i],[rectNew],True,(0,255,0),thickness = 3)
