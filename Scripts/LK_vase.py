...
#        Iw = img[rect[0,1]:rect[2,1] , rect[0,0]:rect[2,0]]
#        print("loop: ", loop)
#        print("subtract: ", abs(np.linalg.norm(Iw) - np.linalg.norm(tmp)))
#        if abs(np.linalg.norm(Iw) - np.linalg.norm(tmp)) > 50 :
#            if np.linalg.norm(Iw) < np.linalg.norm(tmp):
#                print("gamma inc")
#                img  = adjust_gamma(img, gamma=1.01)
#            elif np.linalg.norm(Iw) > np.linalg.norm(tmp):
#                print("gamma reduce")
#                img  = adjust_gamma(img, gamma=0.99)    
